...
export const SubprogramSection = (props: SectionProps) => {
  ...
  return (
    <>
      <ProgramTitleContainer>
        <ProgramTitle variant="bodyMedium" content="SEKCIJA 2 OD 3 - DETALJI POTPROGRAMA" style={{fontWeight: 600}} />
      </ProgramTitleContainer>
      <ProgramWrapper>
        <InputWrapper>
          <Input {...register('title')} label="NAZIV POTPROGRAMA:" error={errors.title?.message as string} />
