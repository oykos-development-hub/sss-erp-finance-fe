...
import AccountingEnforcedPaymentOrdersOverview from './accountingEnforcedPaymentOrdesOverview';
...
export const CurrentAccountingEnforcedPaymentOrderTabs = () => {
  const {
    navigation: {
      navigate,
      location: {pathname},
  ...
  const currentAccountingRoute = useMemo(() => {
    switch (currentAccountingPath) {
      case 'enforced-payments-overview':
        return <AccountingEnforcedPaymentOrdersOverview />;
      default:
        return <AddAccountingEnforcedPaymentOrdes />;
    }
